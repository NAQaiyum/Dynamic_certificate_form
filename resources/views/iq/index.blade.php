                ...
                <div class="table-responsive">
                    <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                        ...
                        <tbody>
                            <tr>
                                <td style="width: 36px;">
                                    <img src="images/user-2.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td style="width: 36px;">
                                    <img src="images/user-3.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td style="width: 36px;">
                                    <img src="images/user-4.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td style="width: 36px;">
                                    <img src="images/user-5.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                </td>
                            ...
                            <tr>
                                <td style="width: 36px;">
                                    <img src="images/user-6.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm">
                                </td>
...
<script src="{{asset('assets/js/pages/flatpickr.min.js')}}"></script>
<script src="{{asset('assets/js/pages/apexcharts.min.js')}}"></script>
<script src="{{asset('assets/libs/selectize/js/selectize.min.js')}}"></script>
